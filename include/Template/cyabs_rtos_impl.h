...
typedef void* /* TODO: Replace with RTOS specific type*/ cy_thread_t;               /**< Alias for the RTOS specific definition of a thread handle */
typedef void* /* TODO: Replace with RTOS specific type*/ cy_thread_arg_t;           /**< Alias for the RTOS specific argument passed to the entry function of a thread */
typedef void* /* TODO: Replace with RTOS specific type*/ cy_mutex_t;                /**< Alias for the RTOS specific definition of a mutex */
typedef void* /* TODO: Replace with RTOS specific type*/ cy_semaphore_t;            /**< Alias for the RTOS specific definition of a semaphore */
typedef void* /* TODO: Replace with RTOS specific type*/ cy_event_t;                /**< Alias for the RTOS specific definition of an event */
typedef void* /* TODO: Replace with RTOS specific type*/ cy_queue_t;                /**< Alias for the RTOS specific definition of a message queue */
typedef void* /* TODO: Replace with RTOS specific type*/ cy_timer_t;                /**< Alias for the RTOS specific definition of a timer */
typedef void* /* TODO: Replace with RTOS specific type*/ cy_timer_callback_arg_t;   /**< Alias for the RTOS specific argument passed to the timer callback function */
typedef void* /* TODO: Replace with RTOS specific type*/ cy_time_t;                 /**< Alias for the RTOS specific time unit (in milliseconds) */
typedef void* /* TODO: Replace with RTOS specific type*/ cy_rtos_error_t;           /**< Alias for the RTOS specific definition of a error status */
